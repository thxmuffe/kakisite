...
<?php theme_add_template_query_option('Login Template', 'pageLoginTemplate', __('Login Template', 'default')); ?><?php theme_add_template_option('Search Template', 'searchTemplate', __('Search Page Template', 'default')); ?>
<?php theme_add_template_query_option('Search Template', 'searchTemplate', __('Search Page Template', 'default')); ?>