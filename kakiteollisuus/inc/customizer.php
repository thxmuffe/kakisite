...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('color_scheme', array(
        'label' => __('Color Scheme', 'kakiteollisuus'),
        'section' => 'colors',
        'type' => 'select',
        'choices' => array(),
        'priority' => 1,
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'kakiteollisuus'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_white_contrast", array(
        'label' => __('Text Dark', 'kakiteollisuus'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_shading_contrast", array(
        'label' => __('Text Light', 'kakiteollisuus'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_background", array(
        'label' => __('Background', 'kakiteollisuus'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control('font_scheme', array(
        'label' => __('Font Scheme', 'kakiteollisuus'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_heading', array(
        'label' => __('Heading Font', 'kakiteollisuus'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_text', array(
        'label' => __('Text Font', 'kakiteollisuus'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_section('typography', array(
        'capability' => 'edit_theme_options',
        'title' => __('Typography', 'kakiteollisuus'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'kakiteollisuus'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'typography_base_size', array(
        'type' => 'number',
        'label' => __('Base Size', 'kakiteollisuus'),
        'section' => 'typography',
        'input_attrs' => array(
            'min'   => 13,
            'max'   => 24,
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'kakiteollisuus'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'kakiteollisuus'),
            '300' => __('300 Light', 'kakiteollisuus'),
            '400' => __('400 Regular', 'kakiteollisuus'),
            '500' => __('500 Medium', 'kakiteollisuus'),
            '700' => __('700 Bold', 'kakiteollisuus'),
            '900' => __('900 Black', 'kakiteollisuus'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'kakiteollisuus'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'kakiteollisuus'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'kakiteollisuus'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'kakiteollisuus'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'kakiteollisuus'),
            'change' => __('Change favicon', 'kakiteollisuus'),
            'remove' => __('Remove', 'kakiteollisuus'),
            'default' => __('Default', 'kakiteollisuus'),
            'placeholder' => __('No favicon selected', 'kakiteollisuus'),
            'frame_title' => __('Select favicon', 'kakiteollisuus'),
            'frame_button' => __('Choose favicon', 'kakiteollisuus'),
        ),
    )));
    ...
    $wp_customize->add_section('menu_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Theme options', 'kakiteollisuus'),
        'panel' => 'nav_menus',
    ));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'kakiteollisuus'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_section('excerpt_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Excerpt', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'kakiteollisuus'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'kakiteollisuus'),
        'description' => sprintf(__('ShortTags: %s', 'kakiteollisuus'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_section('templates_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Templates', 'kakiteollisuus'),
        'priority' => 200,
    ));
        ...
        foreach ($templates_parameters as $templateIndex => $template_options) {
                ...
                if (isset($op['options'])) {
                    foreach ($op['options'] as $key => $option) {
                        if (strpos($key, $templateKey . 'Template') === 0) {
                            ...
                            $templatesOptions[$templateKey][$key] = __($option, 'kakiteollisuus');
                        }
                    }
                }
            }
            if (!in_array($templateKey, $woocommerceTemplateNames) || (in_array($templateKey, $woocommerceTemplateNames) && theme_woocommerce_enabled())) {
                ...
                $wp_customize->add_control( 'theme_template_' . $template . '_' . $templateName . '-template', array(
                    ...
                    'label'       => __( $templateLabel, 'kakiteollisuus' ),
                    'description' => '',
                ) );
            }
        }
    ...
    if (file_exists(get_template_directory() . '/shop/products.json')) {
        ...
        if (isset ($data['products']) && $data['products']) {
            $wp_customize->add_section('products_options', array(
                'capability' => 'edit_theme_options',
                'title' => __('E-Commerce Templates', 'kakiteollisuus'),
                'priority' => 200,
            ));
            ...
            $wp_customize->add_control('links_title', array(
                ...
                'label' => __('Theme With E-Commerce Templates', 'kakiteollisuus'),
...
</br></br>Please copy the following links and paste them into your CMS Menu Item.', 'kakiteollisuus'),
            ));
            ...
            $wp_customize->add_control('products_info', array(
                'type' => 'text',
                'section' => 'products_options',
                'label' => __('Product List Page Template:', 'kakiteollisuus'),
            ...
            $wp_customize->add_control('product_info', array(
                'type' => 'text',
                'section' => 'products_options',
                'label' => __('Product Details Page Template:', 'kakiteollisuus'),
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'kakiteollisuus'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'kakiteollisuus'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'kakiteollisuus'),
        'left-sidebar' => __('Left', 'kakiteollisuus'),
        'right-sidebar' => __('Right', 'kakiteollisuus'),
        'none' => __('None', 'kakiteollisuus'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'kakiteollisuus'),
        'description' => __('Templates for displaying blogs, archives, search results', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'kakiteollisuus'),
        'description' => __('Templates for displaying single posts', 'kakiteollisuus'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'kakiteollisuus'),
        'description' => __('Templates for displaying single pages and everything else', 'kakiteollisuus'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'kakiteollisuus'));
}
