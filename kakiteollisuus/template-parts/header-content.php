<header class="u-clearfix u-header u-header" id="sec-02f3">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
            'default_src' => "/images/Logo-1.png",
            'default_url' => "http://www.blerim.fi/kakiteollisuus"
        )); $url = stripos($logo['url'], 'http') === 0 ? esc_url($logo['url']) : $logo['url']; ?><a <?php if (is_customize_preview()) echo 'data-default-src="' . esc_url($logo['default_src']) . '" '; ?>href="<?php echo $url; ?>" class="u-image u-logo u-image-1 custom-logo-link" data-image-width="560" data-image-height="636">
      ...
      <div class="u-custom-menu u-nav-container-collapse">
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                'container_class' => 'u-menu u-menu-hamburger u-offcanvas u-menu-1',
                'menu' => array(
                    'is_mega_menu' => false,
                    ...
                    'link_style' => 'padding: 10px 1px 10px 20px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-e118-20',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => '',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-e118-22',
                    'submenu_item_class' => 'u-nav-item',
