...
$pageLogin_dialog_path = get_template_directory() . '/template-parts/'. $pageLogin_custom_template . $translations . '/pageLogin-dialogs.php';
if (file_exists($pageLogin_dialog_path)) {
    include $pageLogin_dialog_path;
}
