...
$page404_dialog_path = get_template_directory() . '/template-parts/'. $page404_custom_template . $translations . '/page404-dialogs.php';
if (file_exists($page404_dialog_path)) {
    include $page404_dialog_path;
}
