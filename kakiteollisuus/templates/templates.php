...
<?php theme_register_template('Login Template', 'pageLoginTemplate', 'templates/pageLogin.php'); ?><?php theme_register_template('Search Template', 'searchTemplate', 'templates/search.php'); ?>